...
class ServiceRequest {
	...
	constructor({id, userId,lat, lng, locType, mAddress, mCity, mState, mZip, make, model, year, serviceSelected,
	status, towRange, towType, towAddress, towCity, towState, towZip, zip, arrivalCode, completionCode, 
	customerNotes, adminNotes,updatedAt, createdAt}){
		...
		this._request_data = ["id", "userId", "lat", "lng", "locType", "mAddress", "mCity", "mState", "mZip", "make", 
		"model", "year", "serviceSelected", "status", "towRange", "towType", "towAddress", "towCity", "towState", "towZip", "zip", "arrivalCode", 
		"completionCode", "customerNotes", "adminNotes", "updatedAt", "createdAt"]
		this.STATUS_LEVEL = {
			OPEN: 1, PENDING: 2, ASSIGNED: 3, CANCELLED: 4, ARCHIVED: 5 
		};
	}
}
